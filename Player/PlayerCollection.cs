...
namespace MCForge
{
    public class PlayerCollection : List<Player>, ITypedList
    {
        ...
        public PlayerCollection(IPlayerViewBuilder viewBuilder) { _viewBuilder = viewBuilder; }
        ...
        {
            if (_props == null) { _props = _viewBuilder.GetView(); }
            return _props;
        }

        public string GetListName(PropertyDescriptor[] listAccessors) { return ""; }
    ...
    public class PlayerMethodDescriptor : PropertyDescriptor
    {
        ...
        public PlayerMethodDescriptor(string name, PlayerMethodDelegate method, Type methodReturnType) : base(name, null)
        {
            _method = method;
            _methodReturnType = methodReturnType;
        }

        public override object GetValue(object component) { return _method((Player)component); }
        public override Type ComponentType { get { return typeof(Player); } }
        public override Type PropertyType { get { return _methodReturnType; } }
